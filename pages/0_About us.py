...
with col1:
    st.image("images/eng.jpg", caption=None, width=252)

# Profile Info (Right Column)
with col2:
    st.markdown("### **Aman Kahar**")  # Name & Role
    st.markdown("[LinkedIn](https://www.linkedin.com/in/amankahar/)")  # Social link
    st.write('''Hi, I'm Aman Kahar, a passionate tech enthusiast and an aspiring software developer. Currently pursuing my BCA in AI and Data Analytics,
...
st.markdown("""
    - 📧 Email: **amankaharbusiness@gmail.com**
    - 🔗 [**LinkedIn**](https://www.linkedin.com/in/amankahar/)
""")
